 ...
 *
 * **한 값으로 맞출 수 있으려면 카드 높이가 내용과 무관해야 한다.** `ProjectCard` 는
 * #274 에서 제목·설명·태그 줄 수를 전부 고정해 두어 폭이 1920 이든 390 이든 471px 로
 * 같다(실측). 그런 고정이 없는 카드는 제목 길이·열 폭에 따라 높이가 흔들려서, 여기
 * 넘기는 값은 근사치가 될 수밖에 없다 — 새로 쓸 때 그 카드가 어느 쪽인지 먼저 본다.
 */
