...
describe("PublicLayout", () => {
  ...
  it("홈 · 프로젝트 · 운영진 · 지원하기는 실제 링크이고, 로그인만 클릭할 수 없는 텍스트다", () => {
    renderAt("/");
    ...
    expect(nav.getByText("로그인")).toBeInTheDocument();
    expect(nav.queryAllByRole("link")).toHaveLength(5); // GETIT 로고 + 홈 + 프로젝트 + 운영진 + 지원하기
  });
