 ...
 * 여기 8개로 통일하고 표기는 `사용자 관리` 를 쓴다. **프로젝트 관리(#222)는 와이어프레임
 * 자체에 없던 화면이라 9번째로 새로 얹었다** — BE에 CRUD 엔드포인트는 있는데 대응하는
 * 화면이 없어서 신설함.
 *
...
export const ADMIN_MENU: readonly AdminMenuItem[] = [
  ...
  },
  {
    ...
    label: "프로젝트 관리",
    title: "프로젝트 관리",
    icon: "M4 7a2 2 0 012-2h4l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H6a2 2 0 01-2-2z",
  },
  {
    path: "/admin/users",
    label: "사용자 관리",
